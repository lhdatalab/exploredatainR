...
2. Another way to varify the analysis is to to a random sampling of data approximately equal in size to this sample. Choose a diffrent month/year also at random. Next conduct a hypothesis test to see if the anlysis of the first sample was statistically significant. Of course variations due to weather could lead to a rejection of the null hypothesis.
